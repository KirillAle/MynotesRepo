package kirill.alekseev.mynotes.Adapter;
...
import kirill.alekseev.mynotes.NotesClickListener;
import kirill.alekseev.mynotes.R;
...
public class NotesListAdapter extends RecyclerView.Adapter <NotesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull NotesViewHolder holder, int position) {
        ...
        if(list.get(position).isPinned()) {
            holder.imageView_pin.setImageResource(R.drawable.pin_con);
        } else {
